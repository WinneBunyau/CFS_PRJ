...
<head>
   <meta charset="UTF-8">
   <title>Admin Crop Produce Management</title>
   <!-- Bootstrap CSS -->
...
<div class="container mt-5">
  <div class="box">
    <div class="box-header">
      <h3>Admin Crop Produce Management</h3>
      <div>
        ...
        <tbody>
          <%
            ...
            try {
              ...
              // Join crop_produce with crops to get crop name
              String sql = "SELECT cp.*, c.crop_name FROM crop_produce cp JOIN crops c ON cp.crop_id = c.crop_id";
          ...
          <tr>
             ...
             <td>
               ...
               <button class="btn btn-danger" onclick="confirmDelete(<%= rs.getInt("crop_produce_id") %>)">Delete</button>
             </td>
          </tr>
    ...
    <div class="modal fade" id="deleteConfirmModal" tabindex="-1" aria-labelledby="deleteConfirmModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to delete this crop produce ? This action cannot be undone.
                </div>
...
window.onload = function() {
    ...
    function confirmDelete(crop_produce_id) {
            // Set the delete URL dynamically
            document.getElementById("confirmDeleteBtn").href = "DeleteCropProduceServlet?id=" + crop_produce_id;
